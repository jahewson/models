# Running DeepLab on Iris Semantic Segmentation Dataset

This page walks through the steps required to run DeepLab on Iris on a
local machine.
...
The converted dataset will be saved at ./deeplab/datasets/iris/tfrecord.
...
results (when training DeepLab on the Iris train set).
...
${PATH_TO_DATASET} is the directory in which the Iris dataset resides.
